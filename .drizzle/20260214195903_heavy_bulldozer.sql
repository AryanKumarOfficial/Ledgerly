CREATE TYPE "public"."verification_type" AS ENUM('EMAIL_VERIFIED', 'PASSEORD_RESET', 'MAGIL_LINK');--> statement-breakpoint
...
CREATE INDEX "verification_expiry_idx" ON "verification_token" USING btree ("expires_at");